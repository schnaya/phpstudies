...
$main_template = file_get_contents("page5.html");
...
$sth = $dbh->prepare("SELECT price FROM `tours`");
$sth->execute();
...
$main_template= str_replace("{change}",file_get_contents("http://myhost/templates/change.html"), $main_template);
